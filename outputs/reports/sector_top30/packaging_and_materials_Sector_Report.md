# Packaging & Materials Sector Report
...
- 종목 수: 1
- Top Pick: 동원시스템즈(주) (014820)
- 평균 composite score: 0.49
...
상위 종목의 퀀트 점수와 재무 모멘텀을 함께 점검해야 하는 섹터다. 최신 Top1 구성종목 중 대표 종목은 동원시스템즈(주)이며, 섹터 평균 composite score는 0.49다. 이 섹터의 자동 valuation anchor는 PER with PBR cross-check이며, PBR/ROE, sales growth, operating margin로 검증한다.

## Constituents

| Rank | Ticker | Name | Composite | ML | PER | PBR | Sales Growth | OPM |
|---:|---|---|---:|---:|---:|---:|---:|---:|
| 30 | 014820 | 동원시스템즈(주) | 0.49 | -0.40 | 10.2x | 0.6x | 2.9% | 4.4% |
